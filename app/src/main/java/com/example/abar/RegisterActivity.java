        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txtEmail) || TextUtils.isEmpty(txtPassword)) {
                    ...
                    registrationManager.registerUser(txtUsername, txtName, txtEmail, txtPassword, new RegistrationManager.RegistrationCallback() {
                        @Override
                        public void onRegistrationSuccess() {
                            Toast.makeText(RegisterActivity.this, "Update the profile for a better experience", Toast.LENGTH_SHORT).show();
